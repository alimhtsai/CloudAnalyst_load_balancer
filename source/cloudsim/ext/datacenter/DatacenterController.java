...
public class DatacenterController extends DatacenterBroker implements GeoLocatable,
	...
	public DatacenterController(String name, 
		...
		} else if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_FCFS)){ 
			this.loadBalancer = new FirstComeFirstServeVmLoadBalancer(vmStatesList);
			
		} else if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_HB)){ 
	...
	public Map<VirtualMachineState, Set<Integer>> getvmStatesListThrottled() {
