...
public interface Constants {
	...
	final String LOAD_BALANCE_DLB = "Dynamic Load Balancer"; //change here
	final String LOAD_BALANCE_FCFS = "First Come First Serve";
	final String LOAD_BALANCE_HB = "Honey Bee";
}
